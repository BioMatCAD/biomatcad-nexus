...
public class JobEnvelopeTests
{
    ...
    public void JobInput_DeserializesFromCanonicalJson()
    {
        ...
        Assert.Equal(0.4, job.Recipe.Topology.WallThicknessMm);
    }
    ...
    public void WorkerResultOutput_RoundTripsThroughJson()
    {
        var output = new WorkerResultOutput
        {
            ...
            Metrics = new GeometryMetrics { VolumeMm3 = 123.4, IsWatertight = true, TriangleCount = 10, VertexCountUnique = 8 },
            WorkerVersion = "0.1.0",
